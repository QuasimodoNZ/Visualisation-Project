...
class Person(models.Model):
    ...
    NAICSI = models.IntegerField(verbose_name='North American Industry Classification (NAICS) Categories', choices=choices.NAICSI, null=True)
    ...
    OCCI = models.IntegerField(verbose_name='Occupational Industry Categories', choices=choices.OCCI, null=True)
    ...
    SOCI = models.IntegerField(verbose_name='Standard Occupational Classifcation (SOC) Categories', choices=choices.SOCI, null=True)
